...
<?php get_header(); ?>
    ...
    <section class="block-all container d-flex">
        <div class="block-all__left d-flex position-relative">
            <?php
                $imgAlt = get_post_meta( get_the_ID(), 'block-discount_img_alt' )[0];
                $imgSrc = get_post_meta( get_the_ID(), 'block-discount_img' )[0];

                if( $imgSrc != '' ) {
                    echo '<img src="' . $imgSrc . '" alt="' . $imgAlt . '" width="569px" height="326px" />';
                } else {
                    echo '<img src="' . get_stylesheet_directory_uri() . '/assets/jewelry-banner-img-1.png" alt="' . $imgAlt . '" width="569px" height="326px">';
                }
            ?>
            <div class="block">
                ...
                <div class="zhadan-alex-testovoye-5 mb-30">
                    <?php
                        if( esc_html(get_theme_mod( 'jw_block-all_header_4' )) != '' ) {
                            ...
                            echo 'Curabitur non nullat amet.';
                        }
                     ?>
                </div>
                <div>
        ...
        <div class="block-all__right d-flex">
            <div class="block">
                <div class="zhadan-alex-testovoye-5 black">FEATURED PRODUCTS</div>
            </div>
            <div class="block">
                <div class="zhadan-alex-testovoye-5 black">NEW PRODUCTS</div>
            </div>
        </div>
    </section>
<?php get_footer(); ?>